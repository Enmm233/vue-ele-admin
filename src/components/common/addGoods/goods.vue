			...
			<div class="item">
				<div class="flex flex_item_mid">
					...
					<div class="tit_select">
						<el-select placeholder="产品" class="handle-select mr10">
							<el-option key="bbk" label="产品" value="bbk"></el-option>
							<el-option key="xtc" label="服务" value="xtc"></el-option>
						</el-select>
						<el-select placeholder="默认分类" class="handle-select mr10">
				...
				<el-table 
					...
					<el-table-column prop="date" label="产品ID" width="180">
					</el-table-column>
