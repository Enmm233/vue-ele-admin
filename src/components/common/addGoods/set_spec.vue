		...
		methods: {
			...
			addlist2() {
				...
				if (this.number == 1) {
					...
					// console.log(2)
					if (this.oneList[this.ind].shopWaresSpec.shopWaresSpecItems[this.ind2].itemName == '' && this.oneList[this.ind].shopWaresSpec.shopWaresSpecItems[this.ind2].shopWaresSpecItemItems == '') {
						// console.log("无名")
