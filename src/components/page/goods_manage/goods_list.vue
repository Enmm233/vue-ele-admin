	...
	<div>
		<div class="goods_list">
			<div class="container">
						...
						<el-form-item label="商品性质">
							<div class="flex flex-wrap">
								<el-select v-model="waresTypeStr" placeholder="默认" @change="selectFive" class="handle-select mr10">
									<el-option
									  v-for="(item,index) in waresTypeList"
									  :key="item.type"
									  :label="item.val"
									  :value="index">
									</el-option>
				...
				<el-table :data="tableData.data" class="table" :row-class-name="tableRowClassName" border height="520" ref="multipleTable"
				 header-cell-class-name="table-header" @selection-change="handleSelectionChange">
					...
					<el-table-column label="商品图片" align="center">
						<template slot-scope="scope">
							<el-image class="table-td-thumb" :src="scope.row.waresImg" :preview-src-list="[scope.row.waresImg]"></el-image>
						</template>
					</el-table-column>
					...
					<el-table-column label="操作" width="300">
						<template slot-scope="scope">
							...
							<el-button class="ssmall_btn" style="background-color: #3B50F7;" @click="handleEdit(scope.$index, scope.row)">下架</el-button>
			...
			<!-- 评论弹出框 -->
			<el-dialog title="评论列表" :visible.sync="editVisible1" width="80%">
			...
			<!-- 查看弹出框 -->
			<el-dialog title="商品详情" :visible.sync="editVisible2" width="70%">
			...
			<el-dialog title="产品入库" :visible.sync="editVisible3" width="50%">
