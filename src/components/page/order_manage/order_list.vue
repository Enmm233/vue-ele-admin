		...
		<div class="container">
			<div class="handle-box flex flex_item_between">
				<el-form ref="form" :model="form" class="flex flex-wrap" label-width="80px">
					...
					<el-form-item label="商品ID">
						<el-input v-model="form.name" placeholder="输入商品ID" class="handle-input mr10"></el-input>
					</el-form-item>
				</el-form>
				<block>
			...
			<el-table height="600" :data="tableData" border class="table" ref="multipleTable" header-cell-class-name="table-header"
			 @selection-change="handleSelectionChange">
				...
				<el-table-column prop="name" label="下单时间" width="300"></el-table-column>
				<el-table-column label="总金额" width="100">
					<template slot-scope="scope">￥{{scope.row.money}}</template>
				</el-table-column>
				<el-table-column prop="id" label="订单状态" align="center" width="100"></el-table-column>
				<el-table-column prop="date" label="下单平台" align="center" width="100"></el-table-column>
				<el-table-column prop="id" label="用户备注" align="center" width="100"></el-table-column>
				<el-table-column prop="id" label="产品名称" align="center" width="100"></el-table-column>
		
				<el-table-column prop="id" label="已选规格" align="center" width="100"></el-table-column>
				<el-table-column prop="id" label="地区" align="center" width="100"></el-table-column>

				<el-table-column label="操作" align="center">
					<template slot-scope="scope">
						<el-button type="success" size="mini" @click="handleEdit(scope.$index, scope.row)">详情</el-button>
						<el-button type="success" size="mini" @click="handleEdit(scope.$index, scope.row)">发货</el-button>
						<el-button type="success" size="mini" @click="handleEdit(scope.$index, scope.row)">备货</el-button>
					</template>
				</el-table-column>
			</el-table>
